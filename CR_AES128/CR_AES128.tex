...
\begin{document}
	...
	Après avoir tapé la commande : \\
	 ...
	 Tous d'abord la fonction \verb|commande| comprend que l'on veut encrypter (\verb|-e|) le fichier \verb|test.txt| avec la clé maitre \verb|"aes128 clemaitre"| et la nonce \verb|azertyuiopqsdfgh|. On lance donc la fonction :\\ \verb|aes_128(struct init_matrix *init, int **master_key, int **nonce)| \\
	 qui créer la clé de tour et lance la fonction : \\
